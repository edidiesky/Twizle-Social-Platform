...
const tweeturl: string = "https://twitter-api-indol.vercel.app/api/v1/tweet";
type tweetdatatype = {
  tweet_text?: string;
  tweet_image?: any;
...
export const getAllBookmarkedTweet = createAsyncThunk<{
  ...
  async (tweetData, { rejectWithValue, getState }) => {
    try {
      ...
      const response = await axios.get('https://twitter-api-indol.vercel.app/api/v1/tweet/bookmark', config);
    ...
    try {
      ...
      if (response?.data?.tweet) {
        const response2 = await axios.get(
          `https://twitter-api-indol.vercel.app/api/v1/tweet`,
          config
        );
  ...
  async (Detailsdata, { rejectWithValue, getState }) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://twitter-api-indol.vercel.app/api/v1/tweet/Details/${Detailsdata?._id}`,
        Detailsdata,
        config
      );
  ...
  async ({Detailsdata}, { rejectWithValue, getState }) => {
    ...
    try {
      ...
      const response1 = await axios.put(
        `https://twitter-api-indol.vercel.app/api/v1/tweet/bookmark/${Detailsdata}`,
        Detailsdata,
        config
      );
      const response2 = await axios.get(
        `https://twitter-api-indol.vercel.app/api/v1/tweet/${Detailsdata}`,
        config
      );
      return {
...
>(
  ...
  async ({ Detailsdata }, { rejectWithValue, getState }) => {
    try {
      ...
      await axios.delete(`https://twitter-api-indol.vercel.app/api/v1/tweet/${Detailsdata}`, config);
...
>(
  ...
  async ({Detailsdata}, { rejectWithValue, getState }) => {
    try {
      ...
      const response = await axios.put(
        `https://twitter-api-indol.vercel.app/api/v1/tweet/like/${Detailsdata}`,
        null,
        config
      );
      const response1 = await axios.get(`https://twitter-api-indol.vercel.app/api/v1/tweet/${Detailsdata}`, config);
      const response2 = await axios.get(`https://twitter-api-indol.vercel.app/api/v1/tweet/`, config);
...
export const GetUserTweet = createAsyncThunk<{
  ...
  async (Detailsdata, { rejectWithValue, getState }) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://twitter-api-indol.vercel.app/api/v1/tweet/user/${Detailsdata}`,
        config
      );
  ...
  async (Detailsdata, { rejectWithValue, getState }) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://twitter-api-indol.vercel.app/api/v1/tweet/repost/${Detailsdata}`,
        null,
        config
      );
      return response.data.tweet;
