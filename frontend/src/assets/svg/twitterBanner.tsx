...
const TwitterBanner: React.FC = () => {
    return (
       ...
       <div className="flex column gap-2">
            <svg style={{ fill: "var(--dark-1)", margin:" auto", height: "160px", width: "160px" }} viewBox="0 0 28 40" preserveAspectRatio="xMinYMin meet">
            ...
            {/* <h4 className="fs-20 text-start text-bold text-white">Twizzle</h4> */}
       </div>
    )
}
